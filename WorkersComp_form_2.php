...
?>
          ...
          <tr>
            ...
            <td width="389"><input type="text" name="HoursPWeek" size="30"  value="<?php echo $a_patient->hours_week?>" /></td></tr>
            <tr>
            <td width="128">DOI</td>
    <td width="389" ><input name="InjuryDate"  value="<?php echo ((($a_patient->injury_dateof!='')&&($a_patient->injury_dateof!='0000-00-00'))?date("d/m/Y",convertToDate($a_patient->injury_dateof)):''); ?>" />
      <input type="button" value="select" onclick="displayDatePicker('InjuryDate', false, 'dmy', '/');" /></td>
        ...
        <table border="0" cellspacing="0" cellpadding="5" width="100%">
          <tr>
            ...
            <td width="261" class="field"><select name="Doctor">
                <?
	$wut=NULL;
	$wut['']='Please select';
...
?>
          ...
          <tr>
            ...
            <td width="261" class="field"><select name="Location">
                <?
	$wut=NULL;
	$wut['']='Please select';
...
<img src="images/fish.png" width="104" height="20" alt="CHROMIS medical health services" /></div>
</div>
           </div><!-----------END CONTENT-------->
          <!----end navButtons------>
      <div id="footer">
